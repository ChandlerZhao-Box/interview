package com.chandler.interview.pages
...
import com.chandler.interview.services.QaModule
...
class NavigationSpec extends Specification {
    ...
    def setupSpec() {
        tester = new TapestryTester("com.chandler.interview", "app", "src/main/webapp", QaModule.class)
    }
